...
import { calculateDefenderTransition } from "~/components/stats/defence";
import {
	type ChartConfig,
	ChartContainer,
	ChartTooltip,
...
export const DefenceMemberTransitionRadar = ({
	data,
}: { data: MatchDataWithEvents }) => {
	const transformedData = calculateDefenderTransition(
		data.events,
		data.dogTeamName,
	);
